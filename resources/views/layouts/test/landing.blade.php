...
@section('content')
    ...
    {{-- <div class="hero-image">
        <div class="hero-content">
            <div class="col-md-4 hero-text">
                <h3>
                    Welcome to the site Welcome to0 the site
                </h3>
    ...
    <div class="container">
        <div class="content-head">
            ...
            <p style="text-align: center">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quam accusamus eos
                quibusdam, esse voluptates voluptatibus id corporis facere neque amet alias molestias itaque ex porro
                architecto blanditiis distinctio maxime laboriosam.</h2>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-sm-12 col-lg-4 product">
                <a href="{ route('shop.show')}" class="custom-card">
                    <div class="card view overlay zoom">
                        <img src="" class="card-img-top img-fluid" alt="...">
                        <div class="card-body">
                            <h5 class="card-title"><span class="float-right">$
                                </span></h5>
